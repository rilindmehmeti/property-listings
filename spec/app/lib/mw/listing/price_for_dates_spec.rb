describe Mw::Listing::PriceForDates do
  ...
  describe ".call" do
    ...
    context "when listing has seasonal rate" do
      let(:seasonal_start_date) { Date.parse("2021-07-01") }
      let(:seasonal_end_date)   { Date.parse("2021-09-01") }
      ...
      context "when dates of search are partially in the seasonal rate" do
